...
import pytesseract
import os
from script.preprocessing import process_document
from script.document_reader import (
    perform_ocr, 
...
def benchmark_ocr_methods(input_path, reference_text=None):
    ...
    report_file = os.path.join('data', 'output', 'ocr_benchmark_report.xlsx')
    ...
    if reference_text:
        ...
        generate_diff_report(
            reference_text, 
            best_method['text'],
            os.path.join('data', 'output', 'best_method_diff.html')
        )
